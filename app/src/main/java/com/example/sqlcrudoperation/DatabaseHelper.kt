...
class DataBaseHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    fun updateDatabaseData(id:String, name: String, email: String, password: String, userId: String,contact: String):Boolean
    {
        val db = this.writableDatabase
    ...
    fun deleteDatabaseData(id: String): Boolean {
        val db = this.writableDatabase
    ...
    companion object{
        ...
        private val DATABASE_NAME = "AIMIT"

        // below is the variable for database version
        private val DATABASE_VERSION = 1

        // below is the variable for table name
        val TABLE_NAME = "STUDENTDATA"
